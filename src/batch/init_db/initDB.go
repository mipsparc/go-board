...
func main() {
	...
	stmt := `
		...
		INSERT INTO thread (thread_id, title) VALUES 
			(4109843198431, "とりとめもない雑談"),
			(1320250952095, "鉄道技術雑談"),
			(650945532, "最新動向やスジなど")
	   ;
		CREATE TABLE post (
		...
		INSERT INTO post (post_id, thread_id, user_id, text, time) VALUES
			("193959309349", 4109843198431, 1, "テスト1 in とりとめもない雑談", "2026-03-07 00:00:00"),
			("432430413091", 4109843198431, 1, "テスト2 in とりとめもない雑談", "2026-03-07 02:00:00"),
			("243832093298", 4109843198431, 2, "テスト3 in yosameとりとめもない雑談", "2026-04-07 03:00:00")
		;
	`
	_, err = db.Exec(stmt)
	if err != nil {
